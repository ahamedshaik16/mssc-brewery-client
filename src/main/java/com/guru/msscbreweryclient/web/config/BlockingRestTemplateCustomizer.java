package com.guru.msscbreweryclient.web.config;
...
public class BlockingRestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    private final Integer connectionRequestsTimeout;
    ...
    public BlockingRestTemplateCustomizer(@Value("${sfg.maxtotalconnections}") Integer maxTotalConnections,
                                          ...
                                          @Value("${sfg.connectionrequesttimeout}") Integer connectionRequestsTimeout,
                                          @Value("${sfg.sockettimeout}") Integer socketTimeout) {
        this.maxTotalConnections = maxTotalConnections;
        this.defaultMaxTotalConnections = defaultMaxTotalConnections;
        this.connectionRequestsTimeout = connectionRequestsTimeout;
    ...
    public ClientHttpRequestFactory clientHttpRequestFactory() {
        ...
        RequestConfig requestConfig = RequestConfig
                .custom()
                .setConnectionRequestTimeout(connectionRequestsTimeout)
